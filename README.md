...
| Project Repo | Demo | Description |
| -- | -- | -- |
| [Mapty App](https://github.com/AfterWaGa/Mapty-App) | [Live Demo](https://afterwaga.github.io/Mapty-App/) | Training JS Application made by course of Jonas Schmedtmann. Uses Geolocation API. Allows you to specify points of physical activity on the map, such as running and riding. It also allows you to set characteristics such as distance traveled, duration, and temp. Saves data to localStorage. |
